...
links:
  ...
  pr: null
files:
 - frontend_ai_book/docs/module-1/chapter-1-ros-core.md
 - frontend_ai_book/docs/module-1/chapter-2-python-bridge.md
 - frontend_ai_book/docs/module-1/chapter-3-urdf-modeling.md
 - frontend_ai_book/sidebars.ts
...
```
you have already initialize project of the docusaurus in the frontend-ai-book folder now you can implement in it.
```
...
- Created three comprehensive chapters in frontend_ai_book/docs/module-1/:
...
- Updated frontend_ai_book/sidebars.ts to include the new module and chapters in navigation
